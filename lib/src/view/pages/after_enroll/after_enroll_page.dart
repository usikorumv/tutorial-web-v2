...
class AfterEnrolPage extends StatefulWidget {
  const AfterEnrolPage({Key? key}) : super(key: key);

  @override
  State<AfterEnrolPage> createState() => _AfterEnrolPageState();
}

class _AfterEnrolPageState extends State<AfterEnrolPage> {
